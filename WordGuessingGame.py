...
print("""
      Level 1 : Unlimitted mooves and simple words (practice level)
      Level 2 : Unlimitted moves, 3 lifelines, longer words
      Level 3 : Longer words, 20 attempts and 5 lifelines
      Level 4 : More complex words, 20 attempts and 3 lifelines with dynamic revealing
""")
...
while True:
    ...
    # Level 3
        ...
        print("--- Longer words, 20 attempts and 5 lifelines to reach ---")
        hint = False
        atmpt = True
        life_use = True
        dynamic_revealing = False
    ...
    # Level 4
        ...
        print("\n____   LEVEL : 4    ____")
        print("--- Complex words and 10 attempts to reach ---")
        hint = True
        atmpt = True
    ...
    hints = {
        "hemoglobin": "RBC Protein, carries oxygen",
    ...
    # Takes user input
    print("\n----- Guess the word and 'one alphabet at a time' ----")
    ...
    while ("_" in display):     # Winning condition
        ...
        if (dynamic_revealing):
            ...
            if (wrong_count >= 4 and lifelines != 0):
                life1 = input("\n  Wanna use lifelines? (y/n) : ")
    ...
    while (play not in ["y","n"]):
        play = input("'y' for yes and 'n' for no: ")
